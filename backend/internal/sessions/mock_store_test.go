...
// mockStore implements Store for handler tests. Set only the *Fn fields
...
type mockStore struct {
	Store
	createLobbyFn      func(*Lobby) error
	getLobbyFn         func(string) (*Lobby, error)
	updateLobbyFn      func(*Lobby) error
	deleteLobbyFn      func(string) error
	createGameFn       func(*Game) error
	getGameFn          func(string) (*Game, error)
	updateGameFn       func(*Game) error
...
func (m *mockStore) CreateLobby(l *Lobby) error                   { return m.createLobbyFn(l) }
func (m *mockStore) GetLobby(id string) (*Lobby, error)           { return m.getLobbyFn(id) }
func (m *mockStore) UpdateLobby(l *Lobby) error                   { return m.updateLobbyFn(l) }
func (m *mockStore) DeleteLobby(id string) error                  { return m.deleteLobbyFn(id) }
func (m *mockStore) CreateGame(g *Game) error                     { return m.createGameFn(g) }
func (m *mockStore) GetGame(id string) (*Game, error)             { return m.getGameFn(id) }
func (m *mockStore) UpdateGame(g *Game) error                     { return m.updateGameFn(g) }
func (m *mockStore) SetPlayerToken(tok, lid, pid string) error    { return m.setPlayerTokenFn(tok, lid, pid) }
func (m *mockStore) GetPlayerByToken(tok string) (string, string, error) {
	return m.getPlayerByTokenFn(tok)
}
